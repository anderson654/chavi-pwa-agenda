...
module.exports = configure(function (ctx) {
  return {
    ...
    build: {
      env: ctx.dev
        ? {
          VUE_APP_API_URL: "http://10.201.9.190:3000/api",            
          // VUE_APP_API_URL: "http://192.168.42.229:3000/api",
    ...
    pwa: {
      ...
      manifest: {
        name: `Chavi Agenda`,
        short_name: `Chavi Agenda`,
        description: `Agenda de visitas Chavi`,
        display: "standalone",
