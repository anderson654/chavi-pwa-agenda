...
export default {
    ...
    mounted() {
        let coworkingSecao = this.$store.getters.getCoworkingNome ? this.$store.getters.getCoworkingNome : undefined;
        if (coworkingSecao == undefined || coworkingSecao != "haus") {
        ...
        this.andarSelecionado = this.$store.getters.andarSelecionado? this.$store.getters.andarSelecionado: " 1º andar";
    ...
    methods: {
        ...
        async carregarImoveis() {
            const response = await this.executeMethod({
                ...
                method: "get",
                params: {
                    entidadeId: "669136394fcad3d9e9303c62",
                },
            });
