  ...
  <q-layout view="lHh Lpr lFf">
    <q-page-container>
      <q-page padding>
        ...
        <div class="full-width flex flex-center" style="margin-top: 4rem">
          <div
            class="text-center column q-gutter-lg shadow-1 full-width q-py-xs q-pb-xl"
            style="border-radius: 20px"
          >
            <span class="text-black text-h5"
              >Seu pagamento foi concluído com sucesso!</span
            >
            <span class="text-black text-h5">Agradecemos a sua visita.</span>
            <div>
              <q-btn
                class="q-pa-sm text-bold"
                color="primary"
                text-color="white"
                label="Receber minha chavi"
                @click="
